 ...
 *
 * VGA 1D cellular automata (Tiny Tapeout 09). Archived step: original
 * template top was tt_um_example; renamed to tt_um_vga_ca for clarity.
 * Requires hvsync_generator.v on the compile list if you simulate this file.
 */
