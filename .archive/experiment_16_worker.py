"""
Experiment 16: supervised baseline vs clamp-relax local error (fixed DAG) vs clamp-relax + adaptive wiring.

Job tuple matches experiment 14/15:
...
def run_one(
    ...
    if variant == 0:
        ...
        m = adcr.TTAdaptiveDAGClampRelax(
            n_in=n_in,
            n_out=n_out,
            G=G,
            target=tgt,
