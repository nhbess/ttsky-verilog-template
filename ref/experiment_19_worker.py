"""
Experiment 19 — capacity sweep: same job tuple as experiment 16, but variant 2 is Exp18 (not clamp+DAG).

Job:
  (variant, n_in, n_out, kind, traj_seed, max_ticks, fixed_table_seed, extra_gates, log_stride)

variant 0 = Exp12 supervised
variant 1 = TTAdaptiveDAGClampRelaxFixed (Exp16 local E, LUT-only)
variant 2 = TTAdaptiveDAGLocalLutStats argmax (Exp18 counterfactual targets)
"""
